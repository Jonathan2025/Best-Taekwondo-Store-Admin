// Here we created a navigation component that will be called in the index.js
        ...
        <aside className="text-white p-4 pr-0">
            ...
            <Link href={'/'} className ="flex gap-1 mb-5"> 
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    Best TKD Online Admin
            </Link>

            {/* flex flex col will position the items vertically */}
            <nav className="flex flex-col gap-2">
            
             {/* home icon, if this tab is clicked and is on that route pathname then we will set it as the active link, otherwise its inactive*/}
